@extends('layouts.app')
        ...
        @section('auth-links') 
            @if (Route::has('register'))
                <li class="nav-item">
                    <a class="auth auth-reg" href="{{ route('register') }}">Register</a>
                </li>
            @endif
        @stop
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="login" type="text" class="form-control {{$errors->has('username') || $errors->has('email') ? 'is-invalid' : ''}}" name="login" value="{{old('username') ?: old('email') }}" required autocomplete="login" autofocus>
